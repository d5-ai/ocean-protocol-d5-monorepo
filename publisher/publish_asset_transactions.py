...
from publisher.list_gcs_files import list_gcs_files
...
gcs_files = list_gcs_files('ethereum-etl-prod-2', 'export/transactions')
metadata_files = [
    {
        "index": ind,
        "contentType": "text/text",
        "checksum": file['md5_hash'],
        "checksumType": "MD5",
        "contentLength": str(file['size']),
        "url": file['public_url']
    }
    for ind, file in enumerate(gcs_files)
]
